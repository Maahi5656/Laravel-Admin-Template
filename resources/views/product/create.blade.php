...
@section('content')
    <div class="tableDiv">
        <form method="post" action="{{ route('product.insert') }}" class="w-75 border border-dark p-4" enctype="multipart/form-data">
        	@csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="productDescription" placeholder="Leave a description here" id="floatingTextarea2" style="height: 100px"></textarea>
                <span class="text-danger py-2">
