                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="product-single-img">
                            <div class="item">
                                <img src="{{ asset('uploads/product/'.$details->picture) }}" alt="" style="width: 100%;">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="product-single-content">
                            ...
                            <div class="rating-wrap fix">
                                <span class="pull-left">{{ $details->price }}</span>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="featured-product-wrap">
                        <div class="featured-product-img">
                            <img src="{{ asset('uploads/product/'.$related->picture) }}" alt="">
                        </div>
                        <div class="featured-product-content">
                            <div class="row">
                                <div class="col-7">
                                    <h3><a href="shop.html">{{ $related->name}}</a></h3>
                                    <p>{{ $related->price }}</p>
                                </div>
